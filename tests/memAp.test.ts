...
import * as memOps from '../bits/memory/operations';
...
suite("mem-ap", {}, () => {
    test("read8", () => assert.deepEqual(
        ...
        [
            ...
            `WRITE(1) AP0.CSW <- ${format32(adiDef.CSWMask.VALUE_NO_INC | adiDef.CSWMask.SIZE_8)}`,
            `READ(1) AP0.DRW`
        ]
    ))
    ...
    test("read16", () => assert.deepEqual(
        ...
        [
            ...
            `WRITE(1) AP1.CSW <- ${format32(adiDef.CSWMask.VALUE_NO_INC | adiDef.CSWMask.SIZE_16)}`,
            `READ(1) AP1.DRW`
        ]
    ))
    ...
    test("read32", () => assert.deepEqual(
        ...
        [
            ...
            `WRITE(1) AP2.CSW <- ${format32(adiDef.CSWMask.VALUE_NO_INC | adiDef.CSWMask.SIZE_16)}`,
            `READ(1) AP2.DRW`
        ]
    ))
    ...
    test("readBlockSingleByte", () => assert.deepEqual(
        ...
        [
            ...
            `WRITE(1) AP3.CSW <- ${format32(adiDef.CSWMask.VALUE_NO_INC | adiDef.CSWMask.SIZE_8)}`,
            `READ(1) AP3.DRW`
        ]
    ))
    ...
    test("readBlockHalfWordAligned", () => assert.deepEqual(
        ...
        [
            ...
            `WRITE(1) AP0.CSW <- ${format32(adiDef.CSWMask.VALUE_NO_INC | adiDef.CSWMask.SIZE_16)}`,
            `READ(1) AP0.DRW`
        ]
    ))
    ...
    test("readBlockHalfWordMisaligned", () => assert.deepEqual(
        ...
        [
            ...
            `WRITE(1) AP0.CSW <- ${format32(adiDef.CSWMask.VALUE | adiDef.CSWMask.SIZE_8)}`,
            `READ(1) AP0.DRW`,
            `READ(1) AP0.DRW`
        ]
    ))
    ...
    test("readBlockSingleWordAligned", () => assert.deepEqual(
        ...
        [
            ...
            `WRITE(1) AP0.CSW <- ${format32(adiDef.CSWMask.VALUE_NO_INC | adiDef.CSWMask.SIZE_32)}`,
            `READ(1) AP0.DRW`
        ]
    ))
    ...
    test("readBlockSingleWordMisAligned", () => assert.deepEqual(
        ...
        [
            ...
            `WRITE(1) AP0.CSW <- ${format32(adiDef.CSWMask.VALUE | adiDef.CSWMask.SIZE_8)}`,
            `READ(1) AP0.DRW`,
            `WRITE(1) AP0.CSW <- ${format32(adiDef.CSWMask.VALUE | adiDef.CSWMask.SIZE_16)}`,
            `READ(1) AP0.DRW`,
            `WRITE(1) AP0.CSW <- ${format32(adiDef.CSWMask.VALUE_NO_INC | adiDef.CSWMask.SIZE_8)}`,
            `READ(1) AP0.DRW`,
        ]
    ...
    test("readBytes2", () => assert.deepEqual(
        ...
        [
            ...
            `WRITE(1) AP0.CSW <- ${format32(adiDef.CSWMask.VALUE | adiDef.CSWMask.SIZE_8)}`,
            `READ(1) AP0.DRW`,
            `WRITE(1) AP0.CSW <- ${format32(adiDef.CSWMask.VALUE | adiDef.CSWMask.SIZE_32)}`,
            `READ(1) AP0.DRW`,
            `WRITE(1) AP0.CSW <- ${format32(adiDef.CSWMask.VALUE_NO_INC | adiDef.CSWMask.SIZE_8)}`,
            `READ(1) AP0.DRW`            
        ]
